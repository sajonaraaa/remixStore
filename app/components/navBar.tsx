              ...
              <div className="h-16 flex items-center justify-between">
                ...
                <div className="flex gap-6">
                  <div className="flex gap-6">
                    <button
                      onClick={() => navigate("/")}
                      className="w-40 h-9 bg-purple-300 border border-transparent rounded-md py-3 flex items-center justify-center text-xl font-bold text-slate-900 drop-shadow-2xl hover:bg-purple-200"
                    >
                      Home
                    </button>
                    <button
